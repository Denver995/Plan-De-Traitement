                                  ...
                                  >
                                    ...
                                    {i !== Object.keys(getExamByGroupIndex(groupWithData, groupKey)).length - 1 &&
                                      <p
                                        ...
                                        {(espacementSubExam && (espacementSubExam['group ' + index]['subEspace ' + i] ?
                                          espacementSubExam['group ' + index]['subEspace ' + i].length > 0 &&
                                          espacementSubExam['group ' + index]['subEspace ' + i][espacementSubExam['group ' + index]['subEspace ' + i].length - 1].parentSubExamId === index &&
                                          espacementSubExam['group ' + index]['subEspace ' + i][espacementSubExam['group ' + index]['subEspace ' + i].length - 1].applyOnAll === false : false))
                                          ?
                                          ...
                                          : (espacementSubExam && (espacementSubExam['group ' + index]['subEspace ' + i] ?
                                            espacementSubExam['group ' + index]['subEspace ' + i].length > 0 &&
                                            espacementSubExam['group ' + index]['subEspace ' + i][espacementSubExam['group ' + index]['subEspace ' + i].length - 1].applyOnAll === true &&
                                            espacementSubExam['group ' + index]['subEspace ' + i][espacementSubExam['group ' + index]['subEspace ' + i].length - 1].parentSubExamId === index : false)) ?
