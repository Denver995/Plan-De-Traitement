  ...
  const examForm = (
    <EuiForm className="formulaire">
      <EuiText className="nomexam">
        <EuiHideFor sizes={"none"}>
          <p>
            Modèle :
            <br />
            <span> Xxxxxxx xxxxxx xxxxxxx </span>
          </p>
        </EuiHideFor>
        <EuiHideFor sizes={"none"}>
          <br className="ligne" />
      ...
      <EuiText className="numexam">
        <EuiIcon type="wrench" className="icone" />
        <span> Examen N°xxx</span>
      </EuiText>
      <EuiText>
        {" "}
        <br />{" "}
